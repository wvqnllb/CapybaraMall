<template>
  <el-dialog
    ...
    <el-form-item label="社交登录用户唯一id" prop="socialUid">
      <el-input v-model="dataForm.socialUid" placeholder="社交登录用户唯一id"></el-input>
    </el-form-item>
    <el-form-item label="社交登录的访问令牌" prop="accessToken">
      <el-input v-model="dataForm.accessToken" placeholder="社交登录的访问令牌"></el-input>
    </el-form-item>
    <el-form-item label="社交登录返回的令牌过期时间" prop="expiresIn">
      <el-input v-model="dataForm.expiresIn" placeholder="社交登录返回的令牌过期时间"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          socialUid: [
            { required: true, message: '社交登录用户唯一id不能为空', trigger: 'blur' }
          ],
          accessToken: [
            { required: true, message: '社交登录的访问令牌不能为空', trigger: 'blur' }
          ],
          expiresIn: [
            { required: true, message: '社交登录返回的令牌过期时间不能为空', trigger: 'blur' }
          ]
        }
      }
    },
